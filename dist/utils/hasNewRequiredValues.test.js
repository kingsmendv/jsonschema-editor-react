...
describe("getRequiredMap", function () {
    test("1", function () {
        var schema = {
        ...
        var result = getRequiredMap({
            schema: schema,
        });
        var expected = { root: ["objProp1"] };
    ...
    test("2", function () {
        ...
        var result = getRequiredMap({ schema: schema });
        var expected = { "root.field_qcn6": ["arryObjProp1"] };
        expect(result).toStrictEqual(expected);
    });
    test("3", function () {
        var schema = {
